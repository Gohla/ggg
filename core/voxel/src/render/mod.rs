...
impl VoxelRenderer {
  pub fn new(
    ...
    let vertex_shader_module = gfx.device.create_shader_module(&gfx::include_shader!("vert"));
    let fragment_shader_module = gfx.device.create_shader_module(&gfx::include_shader!("frag"));
